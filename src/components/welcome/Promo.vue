    ...
    <section class="promo">
        <div class="promo-slider">
            ...
            <div class="promo-slider__item promo-slider__item--style-1">
                <picture>
                    <source srcset="@/assets/images/promo_1.jpg" media="(min-width: 835px)" />
                    <source srcset="@/assets/images/834promo_1.jpg" media="(min-width: 376px)" />
                    <img class="img--bg" src="@/assets/images/375promo_1.jpg" alt="img" />
                </picture>
            ...
            <div class="promo-slider__item promo-slider__item--style-2">
                <picture>
                    <source srcset="@/assets/images/promo_2.jpg" media="(min-width: 835px)"/>
                    <source srcset="@/assets/images/834promo_2.jpg" media="(min-width: 376px)"/>
                    <img class="img--bg" src="@/assets/images/375promo_2.jpg" alt="img"/>
                </picture>
                                ...
                                <div class="align-container__item">
                                    <div class="promo-slider__wrapper-1">
                                        <h2 class="promo-slider__title">
                                            ...
                                            <br/><span>of Global Payments</span>
                                        </h2>
                                    </div>
            ...
            <div class="promo-slider__item promo-slider__item--style-3">
                <picture>
                    <source srcset="@/assets/images/promo_3.jpg" media="(min-width: 835px)"/>
                    <source srcset="@/assets/images/834promo_3.jpg" media="(min-width: 376px)"/>
                    <img class="img--bg" src="@/assets/images/375promo_3.jpg" alt="img"/>
                </picture>
